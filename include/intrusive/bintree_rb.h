...
#ifndef CPPCOMMON_INTRUSIVE_BINTREE_RB_H
#define CPPCOMMON_INTRUSIVE_BINTREE_RB_H
...
public:
    ...
    BinTreeRB& operator=(const BinTreeRB&) noexcept = delete;
    ...
    */
    ...
    template <typename U>
    friend void swap(BinTreeRB<U>& bintree1, BinTreeRB<U>& bintree2) noexcept;
...
#endif // CPPCOMMON_INTRUSIVE_BINTREE_RB_H
